...
(function() 
{
	...
	gc.databind.StorageProviderBindFactoryWrapper.prototype.sendValue = function(value)
	{
	    return this._factory.sendValue(value);
	};
...
(function()
{
    ...
    {
        var that = this;
        if (that._hasListeners && this._volatile)
        {
            if (that._state === IDLE)
            {
                that.changeState(READ);
...
(function() // closure for private static methods and data.
{
    ...
    gc.databind.AbstractStreamingDataModel.prototype.encode = function(target, nextValue)
    {
        this.sendPacket(nextValue);
    };
    gc.databind.AbstractStreamingDataModel.prototype.decode = function(target, nextValue)
    {
    ...
    gc.databind.AbstractStreamingDataModel.prototype.createCodec = function(name, codec) 
    {
        codec = codec || this;
        var result = new gc.databind.internal.PacketCodec(name, codec);
        if (!result)
        {
...
(function() 
{
            ...
            listSerialPortsPromise = Q.promise(function(resolve, reject)
            {
                window.setTimeout(function() 
                {
                    ...
                    else
                    {
                        ...
                        {
                            reject('cloud agent is not upto date');
                            return false;
                        });
    ...
    gc.connectionManagerReady = gc.connectionManagerReady || Q.Promise(function(resolve) { gc.connectionManagerFireReady = resolve; });
    gc.connectionManagerFireReady();
